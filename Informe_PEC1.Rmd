...
Creamos el contenedor de tipo *SummarizedExperiment* que contiene los datos, los metadatos de las columnas, los metadatos de las filas y la información de la investigación:
...
Guardamos los metadatos del estudio en un archihvo markdown.
